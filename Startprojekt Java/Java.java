public  class Java {
    public static void main(String[] args) {
        ...
        if(System.console().readLine().equals("Alt+F4")){ //Überberprüft ob die Eingabe "Alt+F4" ist.
            //Wenn ja, kriegt der Nutzer eine Nachricht und das Programm wird beendet.
            System.out.println("Great! You didn't fall for it! Super glad I still have you here!");
            System.out.println("...\nJust kidding, I will exit now. Bye bye! >:3");
            System.exit(0);
        } else {
            //Wenn nein, kriegt der Nutzer eine spöttische Nachricht und das Programm wird beendet.
